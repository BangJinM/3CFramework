...
export class HotUpdate extends Component {
    ...
    private _am: cc.native.AssetsManager = null!;
    ...
    checkUpdate() {
        ...
        if (this._am.getState() === cc.native.AssetsManager.State.UNINITED) {
    ...
    onLoad() {
        ...
        this._storagePath = ((cc.native.fileUtils ? cc.native.fileUtils.getWritablePath() : '/') + 'blackjack-remote-asset');
        console.log('Storage path for remote asset : ' + this._storagePath);

        // Init with empty manifest url for testing custom manifest
        this._am = new cc.native.AssetsManager('', this._storagePath);
