...
export class MoveComponent extends cc.Component {
    ...
    //     let objects = TankQuadTreeManager.GetInstance<TankQuadTreeManager>().GetCollisionObjects([ColliderType.NORMAL, ColliderType.ENEMY, ColliderType.BOUNDARY, ColliderType.PLAYER, ColliderType.PLAYER_BULLET], collisionComp)
    //     if (objects.length > 0) {
    ...
    //     let collisionComp: ColliderEventComp = this.node.getComponent(ColliderEventComp)
    //     if (collisionComp) collisionComp.UpdateXY(position.x, position.y)

    //     if (!TankQuadTreeManager.GetInstance<TankQuadTreeManager>().IsCollisions([ColliderType.NORMAL, ColliderType.PLAYER, ColliderType.ENEMY, ColliderType.BOUNDARY], collisionComp)) {
    //         this.node.setPosition(position)
    //     } else {
    //         collisionComp.UpdateXY(this.node.position.x, this.node.position.y)
    //     }
    ...
    //     let isCollide: boolean = TankQuadTreeManager.GetInstance<TankQuadTreeManager>().IsCollisions([ColliderType.NORMAL, ColliderType.BOUNDARY], collisionComp)
    //     if (!isCollide) {
    //         this.node.setPosition(position)
    //     } else {
    //         collisionComp.UpdateXY(this.node.position.x, this.node.position.y)
